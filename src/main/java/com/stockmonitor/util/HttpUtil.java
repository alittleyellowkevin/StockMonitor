...
public class HttpUtil {
     ...
     * 获取股票排行榜数据
     */
    public String getStockRanking(String asc, String limit, String market, String page, String sort) {
        String result = "";
        ...
        try {
            ...
            String queryParamStr = urlencode(queryParams);

            // url参数拼接
            String url = STOCK_RANKING_URL;
            ...
            conn.setRequestProperty("Host", "ap-guangzhou.cloudmarket-apigw.com");
            conn.setRequestProperty("X-Date", datetime);
     ...
     * @return 股票K线数据
     */
    public String getStockKline(String limit, String ma, String symbol, String type) {
        String result = ""; // 初始化返回值
        BufferedReader in = null;
